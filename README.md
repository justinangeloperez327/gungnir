...
Several subsystems intentionally expose foundations rather than claiming production completeness. In particular, production database adapters beyond the optional PostgreSQL/libpq, MySQL C-client, and SQL Server ODBC adapters, high-concurrency networking, full graceful draining, distributed queue/cache/session backends, complete relationship-query APIs, telemetry exporters and dynamic plugin loading require further work.
